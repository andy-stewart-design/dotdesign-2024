...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from './manifest_6wxpvAbb.mjs';
import 'node:fs';
import { t as trimSlashes, e as appendForwardSlash, j as joinPaths, s as slash$1, p as prependForwardSlash, r as removeTrailingForwardSlash, f as collapseDuplicateSlashes } from './chunks/astro/assets-service_jAVErXsR.mjs';
import { A as AstroError, R as ResponseSentError, t as MiddlewareNoDataOrNextCalled, v as MiddlewareNotAResponse, G as GetStaticPathsRequired, w as InvalidGetStaticPathsReturn, x as InvalidGetStaticPathsEntry, y as GetStaticPathsExpectedParams, z as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, N as NoMatchingStaticPathFound, B as PrerenderDynamicEndpointPathCollide, C as LocalsNotAnObject, D as ROUTE_DATA_SYMBOL, F as ASTRO_VERSION, H as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, J as renderEndpoint, K as ReservedSlotName, O as renderSlotToString, Q as renderJSX, T as chunkToString, V as CantRenderPage, W as renderPage$1, X as REROUTE_DIRECTIVE_HEADER, Y as commonjsGlobal } from './chunks/astro_EhEhwq7z.mjs';
import { s as sequence, o as onRequest } from './chunks/_astro-internal_middleware_IknDhcRb.mjs';
...
function computeCurrentLocale(request, locales, routingStrategy, defaultLocale) {
  const routeData = Reflect.get(request, routeDataSymbol$1);
  if (!routeData) {
...
const _page0 = () => import('./chunks/generic_JqM6yYYy.mjs');
const _page1 = () => import('./chunks/index_UV5GazK7.mjs');
const _page2 = () => import('./chunks/_.._TCrBXKuU.mjs');
const _page3 = () => import('./chunks/test_3vPZ6Hlp.mjs');
const _page4 = () => import('./chunks/index_YarXNW2g.mjs');
const _page5 = () => import('./chunks/index_e7NMzmrk.mjs');
const pageMap = new Map([
    ...
    ["src/pages/about/index.astro", _page5]
]);
